...
INSERT INTO `product` (name,price,description,id_category) VALUES ('bague bleue',270,'Cette bague majestueuse fait honneur à Assa',1),('bague rouge',270,'Cette bague rouge majestueuse fait honneur à mbaye',1),
('Collier Vert',270,'Ce collier majestueuse fait honneur à Assa',2),('Collier rouge',270,'Ce collier rouge majestueuse fait honneur à mbaye16',2)
,('Bracelet Vert',270,'Ce bracelet majestueuse fait honneur à Assa',3),('Bracelet rouge',270,'Ce Bracelet rouge majestueuse fait honneur à mbaye16',3);
...
INSERT INTO `comment` (comment_text,created_at,id_product,id_user) VALUES ("une bague qui tient bien sur le doigt et je l'ai acheté directement en boutique chez la créatrise qui compte bientôt mettre les produit en vente en ligne",now(),1, 2);
